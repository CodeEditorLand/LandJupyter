...
import { debugDecorator, logger, logValue } from "../platform/logging";
...
export class KernelDependencyService implements IKernelDependencyService {
	private installPromises = new Map<
		string,
	...
	constructor(
		...
		protected serviceContainer: IServiceContainer, // @inject(IInteractiveWindowProvider) private readonly interactiveWindowProvider: IInteractiveWindowProvider
	) {}
	/**
