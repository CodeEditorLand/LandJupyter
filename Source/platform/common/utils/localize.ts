...
export namespace Experiments {
	...
	export const inGroup = (groupName: string) =>
		l10n.t("User belongs to experiment group '{0}'", groupName);
}
...
export namespace DataScience {
	...
	export const interactiveWindowTitleFormat = (ownerFileName: string) =>
		l10n.t("Interactive - {0}", ownerFileName);
	...
	export const exportDialogComplete = (fileName: string) =>
		l10n.t("Notebook written to {0}", fileName);
	export const exportDialogFailed = (errorMessage: string) =>
		l10n.t("Failed to export notebook. {0}", errorMessage);
	...
	export const installPackageInstructions = (
		...
		l10n.t(
			"Install '{0}' into the Python environment. \nCommand: '{1}'",
			pythonModuleName,
			commandId,
		);
	export const OrInstallPackageInstructions = (
		pythonModuleName: string,
		commandId: string,
	) =>
		l10n.t(
			"Or install '{0}' using the command: '{1}'",
			pythonModuleName,
			commandId,
		);
	...
	export const connectingToKernel = (kernelName: string) =>
		l10n.t("Connecting to kernel: {0}", kernelName);
	export const connectingToJupyter = l10n.t("Connecting to Jupyter Server");
	export const exportingFormat = (fileName: string) =>
		l10n.t("Exporting {0}", fileName);
	...
	export const connectedKernelHeader = (kernelName: string) =>
		l10n.t("Connected to {0}", kernelName);
	export const restartingKernelCustomHeader = (kernelName: string) =>
		l10n.t("_Restarting {0}..._", kernelName);
	...
	export const startingNewKernelCustomHeader = (kernelName: string) =>
	...
	export const pandasTooOldForViewingFormat = (
		...
		l10n.t({
			...
			comment: [
				"Do not translate 'pandas' as that is a Python module name",
			],
		});
	...
	export const exportImageFailed = (errorMessage: string) =>
		l10n.t("Error exporting image: {0}", errorMessage);
	...
	export const failedToStartKernelDueToPyZmqFailure = l10n.t({
		...
		comment: [
			'Do not translate the string "pyzmq" as that is a Python module.',
		],
	});
	...
	export const failedToFetchKernelSpecsRemoteErrorMessageForQuickPickLabel =
		l10n.t({
			...
			comment:
				"Do not translate the string $(error) as that is a VS Code icon.",
		});
	export const failedToFetchKernelSpecsRemoteErrorMessageForQuickPickDetail =
		l10n.t("Ensure the server is running and reachable.");
	...
	export const dataViewerDeprecationRecommendationActionMessage = l10n.t(
...
export namespace WebViews {
	...
	export const sliceIndexError = l10n.t({
		...
		comment: [
			"Do not translate the strings {0}, {1} and {2} as they are variable names and will be replaced later",
		],
	});
	export const sliceMismatchedAxesError = l10n.t({
		message: "Expected {0} axes, got {1} in slice expression",
		comment: [
			"Do not translate the strings {0} and {2} as they are variable names and will be replaced later",
		],
	});
...
export namespace Products {
	export const installingModule = (moduleName: string) =>
		l10n.t("Installing {0}", moduleName);
}
