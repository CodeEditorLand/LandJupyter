...
import { IJupyterUriProvider, Jupyter, JupyterServerProvider } from "../../api";
...
export function buildApi(
	...
	const envApi = serviceContainer.get<INotebookPythonEnvironmentService>(
	...
	const api: IExtensionApi = {
		...
		registerPythonApi: (pythonApi: PythonApi) =>
			registerPythonApi(pythonApi, serviceContainer),
