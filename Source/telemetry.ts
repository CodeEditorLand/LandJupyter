...
type AllEventPropertiesData<T> = {
	[P in keyof Required<T>]: Required<T>[P] extends number
...
function globallySharedProperties(): PropertyMeasureDefinition<SharedPropertyMapping>["properties"] {
	return {
		isInsiderExtension: {
			...
			comment:
				"Whether this is the Insider version of the Jupyter extension or not. Common to all events.",
		},
		isPythonExtensionInstalled: {
			classification: "SystemMetaData",
			purpose: "FeatureInsight",
			comment:
				"Whether Python extension is installed or not. Common to all events.",
		},
		rawKernelSupported: {
			classification: "SystemMetaData",
			purpose: "FeatureInsight",
			comment:
				"Whether the raw kernel is supported or not. Common to all events.",
		},
	};
}
...
export class IEventNamePropertyMapping {
	 ...
	 */
	[EventName.OPEN_DATAVIEWER_FROM_VARIABLE_WINDOW_REQUEST]: TelemetryEventInfo<
		never | undefined
	> = {
	 ...
	 */
	[EventName.OPEN_DATAVIEWER_FROM_VARIABLE_WINDOW_ERROR]: TelemetryEventInfo<
		never | undefined
	> = {
		owner: "IanMatthewHuff",
		source: "N/A",
	 ...
	 */
	[EventName.OPEN_DATAVIEWER_FROM_VARIABLE_WINDOW_SUCCESS]: TelemetryEventInfo<
		never | undefined
	> = {
		owner: "IanMatthewHuff",
		source: "User Action",
	 ...
	 */
	[Telemetry.DisableInteractiveShiftEnter]: TelemetryEventInfo<
		never | undefined
	> = {
		owner: "amunger",
		feature: ["InteractiveWindow"],
	 ...
	 */
	[Telemetry.EnableInteractiveShiftEnter]: TelemetryEventInfo<
		never | undefined
	> = {
		owner: "amunger",
		feature: ["InteractiveWindow"],
	 ...
	 */
	[Telemetry.ExportPythonFileInteractive]: TelemetryEventInfo<
		never | undefined
	> = {
		owner: "IanMatthewHuff",
	 ...
	 */
	[Telemetry.ExportPythonFileAndOutputInteractive]: TelemetryEventInfo<
		never | undefined
	> = {
		owner: "IanMatthewHuff",
		feature: ["Import-Export", "InteractiveWindow"],
	 ...
	 */
	[Telemetry.RunCurrentCellAndAdvance]: TelemetryEventInfo<
		never | undefined
	> = {
		owner: "amunger",
		feature: ["InteractiveWindow"],
	 ...
	 */
	[Telemetry.UserDidNotInstallJupyter]: TelemetryEventInfo<
		never | undefined
	> = {
		owner: "donjayamanne",
		feature: "N/A",
	...
	[Telemetry.KernelLauncherPerf]: TelemetryEventInfo<
		| (DurationMeasurement & ResourceTypeTelemetryProperty)
		| TelemetryErrorProperties
	> = {
		owner: "donjayamanne",
		feature: "N/A",
	 ...
	 */
	[Telemetry.NewFileForInteractiveWindow]: TelemetryEventInfo<
		never | undefined
	> = {
		owner: "amunger",
		feature: ["InteractiveWindow"],
	...
	[Telemetry.CreateInteractiveWindow]: TelemetryEventInfo<{
		...
		measures: {
			windowCount: {
				...
				purpose: "FeatureInsight",
				comment:
					"Number of active interactive windows the user has open",
				isMeasurement: true,
			},
		},
	};
	 ...
	 */
	[Telemetry.HashedIPyWidgetScriptDiscoveryError]: TelemetryEventInfo<
		never | undefined
	> = {
		owner: "donjayamanne",
		feature: ["Notebook", "InteractiveWindow"],
	...
	[Telemetry.NotebookRestart]: TelemetryEventInfo<
		...
		| /** If there are unhandled exceptions. */ (ResourceTypeTelemetryProperty &
				TelemetryErrorProperties)
	> = {
		owner: "donjayamanne",
		feature: ["Notebook", "InteractiveWindow"],
	 ...
	 */
	[Telemetry.NativeVariableViewMadeVisible]: TelemetryEventInfo<
		never | undefined
	> = {
		owner: "IanMatthewHuff",
		feature: ["VariableViewer"],
	 ...
	 */
	[DebuggingTelemetry.clickedRunByLine]: TelemetryEventInfo<
		never | undefined
	> = {
		owner: "roblourens",
		feature: ["Debugger"],
	 ...
	 */
	[DebuggingTelemetry.successfullyStartedIWJupyterDebugger]: TelemetryEventInfo<
		never | undefined
	> = {
		owner: "roblourens",
		feature: ["Debugger"],
	 ...
	 */
	[DebuggingTelemetry.clickedRunAndDebugCell]: TelemetryEventInfo<
		never | undefined
	> = {
		owner: "roblourens",
		feature: ["Debugger"],
	 ...
	 */
	[DebuggingTelemetry.successfullyStartedRunAndDebugCell]: TelemetryEventInfo<
		never | undefined
	> = {
		owner: "roblourens",
		feature: ["Debugger"],
	 ...
	 */
	[Telemetry.JupyterKernelHiddenViaFilter]: TelemetryEventInfo<
		never | undefined
	> = {
		owner: "donjayamanne",
		source: "N/A",
	 ...
	 */
	[Telemetry.DataViewerUsingInterpreter]: TelemetryEventInfo<
		never | undefined
	> = {
		owner: "IanMatthewHuff",
		feature: ["DataFrameViewer"],
	...
	> = {
		...
		measures: {
			...
			preExecuteDuration: {
				...
				purpose: "PerformanceAndHealth",
				comment:
					"Total time spent in VS Code before starting execution.",
				isMeasurement: true,
			},
			executeDuration: {
				classification: "SystemMetaData",
		...
		properties: {
			outputType: {
				...
				purpose: "FeatureInsight",
				comment:
					"The kind of outputs generated in the notebook, text, html or images.",
			},
		},
	};
	/**
